...
const ContactButton = ({ isMobile = false, onLinkClick }) => (
    <motion.div
        ...
        onClick={onLinkClick}
    >
        {/* <Link href={"https://github.com/GnanaMoorthy06"} target='_blank' className={isMobile ? 'w-full' : ''}>
         ...
         <a
      href="/Gnana_Moorthy_Resume.pdf"
      download="GnanaMoorthy_Resume.pdf" // custom filename when downloaded
